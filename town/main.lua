...
function love.load()
	...
	screen:newCamera(0,0,1280,720,1,0,1505,1337)
	walkMask = res.load('image','town.png')
	walkMaskData = love.image.newImageData('res/images/townMask.png')
	p = player.make(1505,1337)
end
